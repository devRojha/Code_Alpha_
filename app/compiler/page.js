            ...
            <div className={`h-screen border grid grid-cols-2 ${dark?"border-white":"border-black"}`}>
                ...
                <div className={`col-span-1 border-r ${dark?"border-white":"border-black"}`}>
                    <div className={`border-b  h-[40%] ${dark?"border-white":"border-black"}`}>
                        ...
                        <textarea type="textfield" className={`p-4 text-black focus:outline-none w-full h-[83%] ${dark?"bg-black text-white":"bg-slate-200 text-blackfsdfd"}`} />
                    </div>
                    <div className={`border-b  h-[60%] ${dark?"border-white":"border-black"}`}>
                        ...
                        {/* <textarea type="textfield" className={`p-4 text-black focus:outline-none w-full h-[80%] ${dark?"bg-zinc-800 text-white":"bg-slate-200 text-blackfsdfd"}`} /> */}
                    </div>
                </div>
