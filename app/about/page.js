...
export default function Page(){
    ...
    return (
        <div className="px-20 max-lg:px-2 bg-zinc-800 pt-20 text-white">
            ...
            <div className="grid grid-cols-4 space-x-2 py-8">
                <Image className="rounded-lg col-span-1 h-[300px] max-sm:h-[150px] max-sm:mt-20 w-[300px] object-cover border" src={"/owner.jpg"} alt="Loading..." width={3000} height={3000}/>
...
function AboutCompo({title, para}){
    return (
        <div className="mb-10">
            ...
            <div className="text-slate-300 text-justify max-sm:text-[14px]">{para}</div>
        </div>
    )
}